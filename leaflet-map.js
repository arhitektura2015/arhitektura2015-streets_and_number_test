...
var map = L.map('map', {renderer: L.canvas(), zoomControl: false, zoom: 12,minZoom: 5, maxZoom: 18});
...
//     console.log(user_layer_group)
    ...
    var googlemaps =  L.tileLayer('https://mt1.google.com/vt/lyrs=y&x={x}&y={y}&z={z}', {maxNativeZoom:18, id: "GoogleMaps", layername: 'Google знімки із супутника'}).addTo(map)
    
    var openstreetmap =  L.tileLayer('https://tile.openstreetmap.org/{z}/{x}/{y}.png', {id: "OpenStreetMap", layername: 'OpenStreetMap'})
    
    var arcgis_map =  L.tileLayer('https://services.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}.png', {maxNativeZoom:16, id: "WorldImageryArcGIS", layername: 'World Imagery (ArcGIS) знімки із супутника'}) 
...
function display_info(layer) {
	...
	color: blue;">Інформація про право власності та речові права (Е-сервіси ДЗК)</a></p>
            ...
            <th><i class="fa fa-clone" id="copy_ugiddya" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.ugiddya}', this.id)"></i></th>
            </tr>  
            ...
            <th><i class="fa fa-clone" id="copy_silrada" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.silrada}', this.id)"></i></th>
            </tr>  
            
            <tr>
            <th style="font-weight:normal; text-align:left"><b>Фактичний користувач:</b> ${selected_layer.feature.properties.fact_user}</th>
            <th><i class="fa fa-clone" id="copy_fact_user" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.fact_user}', this.id)"></i></th>
            </tr>  
            
            <tr>
            <th style="font-weight:normal; text-align:left"><b>Примітки:</b> ${selected_layer.feature.properties.notes}</th>
            <th><i class="fa fa-clone" id="copy_notes" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.notes}', this.id)"></i></th>
            </tr>  
            ...
            <th><i class="fa fa-clone" id="copy_Approval_parcel_list" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.Approval_parcel_list}','copy_Approval_parcel_list')"></i></th>
            </tr>  
            ...
            <th><i class="fa fa-clone" id="copy_Approval_permission_division" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.Approval_permission_division}', this.id)"></i></th>
            </tr>
            ...
            <th><i class="fa fa-clone" id="copy_Approval_approving_division" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.Approval_approving_division}', this.id)"></i></th>
            </tr>
            ...
            <th><i class="fa fa-clone" id="copy_Approval_permission_change_destination" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.Approval_permission_change_destination}', this.id)"></i></th>
            </tr> 
            ...
            <th><i class="fa fa-clone" id="copy_Approval_approving_change_destination" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.Approval_approving_change_destination}', this.id)"></i></th>
            </tr> 
            ...
            <th><i class="fa fa-clone" id="copy_Approval_permission_bidding" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.Approval_permission_bidding}', this.id)"></i></th>
            </tr> 
            ...
            <th><i class="fa fa-clone" id="copy_NGO_value" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.NGO_value}', this.id)"></i></th>
            </tr>
            ...
            <th><i class="fa fa-clone" id="copy_NGO_date" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.NGO_date}', this.id)"></i></th>
            </tr>
            ...
            <th><i class="fa fa-clone" id="copy_record_data_right" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.record_data_right}', this.id)"></i></th>
            </tr>
            ...
            <th><i class="fa fa-clone" id="copy_record_number_right" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.record_number_right}', this.id)"></i></th>
            </tr>
            ...
            <th><i class="fa fa-clone" id="copy_belonging_state_act" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.belonging_state_act}', this.id)"></i></th>
            </tr>
            ...
            <th><i class="fa fa-clone" id="copy_origin_parcel" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.origin_parcel}', this.id)"></i></th>
            </tr>
            ...
            <th><i class="fa fa-clone" id="copy_transfer_parcel_DZK" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.transfer_parcel_DZK}', this.id)"></i></th>
            </tr>
            ...
            <th><i class="fa fa-clone" id="copy_origin_parcel_cadnum" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.origin_parcel_cadnum}', this.id)"></i></th>
            </tr>
            ...
            <th><i class="fa fa-clone" id="copy_origin_parcel_area" aria-hidden="true" style="cursor: pointer; font-size:18px" onclick="copy_value('${selected_layer.feature.properties.origin_parcel_area}', this.id)"></i></th>
            </tr>
